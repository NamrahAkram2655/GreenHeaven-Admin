...
const AddItem = ({ token }) => {
  ...
  return (
    <main
      className="min-h-screen bg-cover bg-center px-4 sm:px-6 py-6"
      style={{
        backgroundImage:
    ...
    >
      <div className="lg:ml-64 flex justify-center">
        <div className="w-full max-w-3xl bg-white/80 backdrop-blur-md p-4 sm:p-6 rounded-lg shadow-lg">
          <h1
            className="text-2xl sm:text-3xl font-bold text-green-800 text-center mb-6"
            style={{ textShadow: "2px 2px 4px rgba(0,0,0,0.5)" }}
          >
            Add New Greenery
          </h1>

          <form className="space-y-5 text-sm sm:text-base" onSubmit={handleSubmit}>
            {/* Input Fields */}
            {[
              {
                label: "Name",
            ...
            <div>
              ...
              >
                <option value="">Select a category</option>
                {["Indoor", "Outdoor", "Succulents", "Herbs", "Housing", "Flowering"].map(
                  (cat) => (
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label className="text-green-700 font-semibold">Mark as Bestseller</label>
            </div>

            {/* Sizes */}
            <div>
              <label className="block text-green-700 font-semibold mb-1">Sizes</label>
              <div className="flex flex-wrap gap-2">
                {["Small", "Medium", "Large"].map((size) => (
                  <span
                    key={size}
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  { key: "sunlight", placeholder: "E.g., Low to bright light" },
                  { key: "water", placeholder: "E.g., Weekly" },
                  { key: "soil", placeholder: "E.g., Well-draining soil" },
                  { key: "height", placeholder: "E.g., 30-100 cm" },
                  { key: "lifespan", placeholder: "E.g., 5-10 years" },
                ].map(({ key, placeholder }) => (
                  <div key={key}>
                    <label className="block text-sm text-green-600 font-medium mb-1 capitalize">
                      {key}
                    </label>
                    <input
                      type="text"
            ...
            <button
              type="submit"
              className="w-full bg-green-900 text-white font-bold py-3 rounded-md hover:bg-green-700 transition-all"
            >
