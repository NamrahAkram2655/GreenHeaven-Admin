...
export default function ExpenseTrack() {
  return (
    <ExpenseProvider>
      <div
        className="min-h-screen p-4 sm:p-6 bg-cover bg-center"
        style={{
          backgroundImage:
            "url('https://i.pinimg.com/736x/0a/f9/72/0af9721bc5afb32a9f2a0cdf2fe84fd7.jpg')",
        }}
      >
        <div className="max-w-full sm:max-w-6xl mx-auto p-4 sm:p-6 rounded-lg bg-white bg-opacity-80 shadow-md">
          <Balance />
          <IncomeExpenses />
          <AddTransaction />
        </div>
